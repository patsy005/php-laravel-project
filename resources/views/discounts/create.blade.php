            ...
            <main class="main">
                ...
                <section class="section section__bookings mt-5">
                    ...
                    <div class="heading d-flex justify-content-between mb-5">
                        <h1 class="mt-4">Add Discount</h1>
                    </div>
                </section>

                <section class="section section__form">
                    <form action="{{ route('discounts.store') }}" method="POST" class="form">
                        @csrf
                        ...
                        <div class="form-box d-flex justify-content-between row">
                            <div class="input-container col-6 ps-0">
                                ...
                                <input type="date" name="valid_from" class="input-box" value="{{ old('valid_from') }}">
                                @error('valid_from') <p style="color:#FF4D4D">{{ $message }}</p> @enderror
                            </div>

                            <div class="input-container col-6 pe-0">
                                <label for="valid_to">Valid to</label>
                                <input type="date" name="valid_to" class="input-box" value="{{ old('valid_to') }}">
                        ...
                        <div class="input-container">
                            ...
                            <input type="number" name="discount_percentage" class="input-box" value="{{ old('discount_percentage') }}">
                            @error('discount_percentage') <p style="color:#FF4D4D">{{ $message }}</p> @enderror
                        </div>

                        <div class="input-container">
                            <label for="description">Description</label>
                            <input type="text" name="description" class="input-box" value="{{ old('description') }}">
