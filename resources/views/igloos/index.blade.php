...
<div class="modal fade" id="deleteIglooModal" tabindex="-1" aria-labelledby="deleteIglooModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" id="deleteIglooForm">
                @csrf
                @method('DELETE')
                ...
                <div class="modal-body">
                    Are you sure you want to delete igloo <strong id="iglooNameInModal"></strong> (ID: <span id="iglooIdInModal"></span>)?
                </div>
